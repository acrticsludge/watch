      ...
      {aggregateSnapshots.length > 0 && (
        <div className="grid grid-cols-3 gap-3 mb-8">
          <div className="bg-[#111] border border-white/6 rounded-xl px-4 py-3.5">
            ...
            <p className="text-2xl font-semibold text-green-400 tabular-nums leading-none">
              {healthyCount}
            </p>
          </div>
          <div className="bg-[#111] border border-white/6 rounded-xl px-4 py-3.5">
            <p className="text-xs text-zinc-600 mb-1.5 font-medium">Warning</p>
            <p className="text-2xl font-semibold text-amber-400 tabular-nums leading-none">
              {warningCount}
            </p>
          </div>
          <div className="bg-[#111] border border-white/6 rounded-xl px-4 py-3.5">
            <p className="text-xs text-zinc-600 mb-1.5 font-medium">Critical</p>
            <p className="text-2xl font-semibold text-red-400 tabular-nums leading-none">
              {criticalCount}
            </p>
          </div>
        </div>
