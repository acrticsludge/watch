...
Your token has expired or was revoked. Generate a new one and reconnect from the project's **Integrations** tab.
...
2. In Stackwatch, go to **Integrations**, find your GitHub integration, and click the **edit (pencil)** icon
