---
title: Supabase
description: Track database size, MAU, storage, and more
---
...
The Project Reference ID is wrong, or the project has been paused/deleted. Note that free-tier Supabase projects pause after a period of inactivity — you'll need to unpause the project in the Supabase dashboard first.

**"Supabase integration missing project_ref"**
The integration was saved without a Project Reference ID. Delete and re-add it with the correct ref.
