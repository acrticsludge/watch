---
title: Vercel
description: Track bandwidth, build minutes, and function invocations
---
...
The Vercel billing/usage API is only available on Pro and Team plans. You'll need to upgrade your Vercel plan to use this integration.
...
2. In Stackwatch, go to **Integrations**, find your Vercel integration, and click the **edit (pencil)** icon
